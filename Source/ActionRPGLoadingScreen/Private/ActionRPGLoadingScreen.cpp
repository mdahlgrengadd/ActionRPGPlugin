...
struct FRPGLoadingScreenBrush : public FSlateDynamicImageBrush, public FGCObject
{
	...
	{
		// Create a temporary array with our object
		TArray<TObjectPtr<UObject>> Objects;
		Objects.Add(ResourceObject);

		// Add the array to the collector
		Collector.AddReferencedObjects(Objects, nullptr);
	}
...
public:
	...
	void Construct(const FArguments& InArgs)
	{
		...
		static const FName LoadingScreenName(TEXT("/ActionRPGPlugin/ActionRPG/UI/T_ActionRPG_TransparentLogo.T_ActionRPG_TransparentLogo"));
...
public:
	virtual void StartupModule() override
	{
		...
		LoadObject<UObject>(nullptr, TEXT("/ActionRPGPlugin/ActionRPG/UI/T_ActionRPG_TransparentLogo.T_ActionRPG_TransparentLogo") );
